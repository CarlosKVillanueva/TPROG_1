...
public class Final {
	...
	private static void agregarBuceos(CentroBuceoAvanzado cba) {
		...
		agregarBuceo(cba, new Buceo(9, "Pirámides", 25), Mes.NOVIEMBRE);
	...
	private static void registrarBuceadores(CentroBuceoAvanzado cba) {
		...
		registrarBuceadorAdvanced(cba, "Ricardo", "Espaï¿½ol", 23, 7);
	...
	private static void registrarBuceadorOpenWater(CentroBuceoAvanzado cba, String nombre, String nacionalidad, int edad, int idBuceo) {
		try {
