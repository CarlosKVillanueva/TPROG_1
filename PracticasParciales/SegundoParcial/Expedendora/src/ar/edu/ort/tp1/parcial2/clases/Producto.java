...
public class Producto implements Apreciable, Identificable<Integer> {
	...
	private void setPrecio(double precioInicial) {
	...
	public void listarActualizacionesDePrecio() {
		...
		HistoricoActualizacion historico;

		while (!historicoActualizaciones.isEmpty()) {
			historico = historicoActualizaciones.pop();
			System.out.println(historico);
			aux.push(historico);
		}
		while (!aux.isEmpty()) {
			historicoActualizaciones.push(aux.pop());
		}
	}
}