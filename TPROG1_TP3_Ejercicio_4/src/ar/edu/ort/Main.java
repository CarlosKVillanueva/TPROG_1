    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcionCliente) {
                case 1 -> ticket.agregarElectro(heladera);
                case 2 -> ticket.agregarElectro(televisor);
                case 3 -> ticket.agregarElectro(lavarropas);
                case 4 -> ticket.agregarElectro(licuadora);
            }
